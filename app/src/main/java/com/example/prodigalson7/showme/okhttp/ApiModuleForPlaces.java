...
public class ApiModuleForPlaces {
    ...
    public final String BASE_URL = "https://maps.googleapis.com/maps/";
    ...
    @Provides
    public PlaceApiService provideApiService() {
        return provideRetrofit(BASE_URL, provideClient()).create(PlaceApiService.class);
    }
